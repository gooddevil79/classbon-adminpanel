const CourseDetails = function ({ course }) {
	return (
		<>
			<div className="row">
			...
			<div className="row">
				...
				<div className="col-lg-3 col-xl-2 d-flex">
					<div className="card flex-fill text-center">
						...
						<div className="card-body my-0 pt-0">
							<h4 className="text-info fw-bolder">{course.courseLevel}</h4>
						</div>
					</div>
				</div>
				<div className="col-lg-3 col-xl-2 d-flex">
				...
				<div className="col-lg-3 col-xl-2 d-flex">
					<div className="card flex-fill text-center">
						...
						<div className="card-body my-0 pt-0">
							<h4 className="text-info fw-bolder">
								{course.averageReviewRating + " از 5"}
							</h4>
						</div>
					</div>
				</div>
