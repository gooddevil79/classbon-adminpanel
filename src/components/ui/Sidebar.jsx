...
const Sidebar = function () {
	const { sidebarCollapsed } = useAppCtx();
				...
				<ul className="sidebar-nav pe-0">
					...
					<li className="sidebar-item">
						...
						>
							...
							<span className="align-middle me-2">
								{t("sidebar.coursesCategory")}
							</span>
						</NavLink>
					</li>
					<li className="sidebar-item">
						<Link to={"/course-discount"} className="sidebar-link">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="24"
								height="24"
					...
					<li className="sidebar-item">
						<a className="sidebar-link">
							...
							<span className="align-middle me-2">
								{t("sidebar.studentManagement")}
							</span>
						</a>
					</li>
					<li className="sidebar-header fw-bolder fs-lg">
						{t("sidebar.blogManagement")}
					</li>
					<li className="sidebar-item">
						<a className="sidebar-link">
							<svg
